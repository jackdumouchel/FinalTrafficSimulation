...
int main(int argc, char* argv[]){
    ...
    Intersection NW(&lightNS);
    Intersection NE(&lightEW);
    Intersection SW(&lightEW);
    Intersection SE(&lightNS);

    Road northbound(number_of_sections_before_intersection, &SE, &NE, Direction::north);
    Road southbound(number_of_sections_before_intersection, &NW, &SW, Direction::south); 
    Road eastbound(number_of_sections_before_intersection, &SW, &SE, Direction::east);
    Road westbound(number_of_sections_before_intersection, &NE, &NW, Direction::west);
    ...
    for(int i = 0; i < vehicles.size(); i++){
        ...
        animator.setVehiclesEastbound(eastbound.getRoadSnapshot());
        animator.setVehiclesNorthbound(northbound.getRoadSnapshot());
        animator.setVehiclesSouthbound(southbound.getRoadSnapshot());
        animator.setVehiclesWestbound(westbound.getRoadSnapshot());
